...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.prevChapterBtn} />
</label>
...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.togglePlacement} />
</label>
...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.settingsPlacement} />
</label>
...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.chapterContent} />
</label>
...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.chapterTitle} />
</label>
...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.fictionTitle} />
</label>
...
<label>
    ...
    <input
        type="text"
        class="form-control"
        bind:value={settings.closeButtonSelector} />
</label>
